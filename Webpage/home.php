                ...
                <div class="content-lg container">
                    <div class="row">
                        <div class="col-sm-5 sm-margin-b-30">
							<h2 class="color-white">Login Server</h2>
							<form action="login.php" method="post">
							<input type="text" name="username" class="form-control footer-input margin-b-20" placeholder="Organization Name" required>
                            <input type="password" name="password" class="form-control footer-input margin-b-20" autocomplete="off" placeholder="Password" required>
                            <button type="submit" class="btn-theme btn-theme-sm btn-base-bg text-uppercase">Login</button>
							</form>
							<br></br><br></br>
							<li class="nav-item"><a class="nav-item-child nav-item-hover" href="Register.php">Register the Server</a></li>
                        </div>
                    </div>
                    <!--// end row -->
                </div>

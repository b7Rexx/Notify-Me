...
<html lang="en" class="no-js" >
    ...
    <body>
        ...
        <!--========== FOOTER ==========-->
		<style>
		.table-design{width: 100%;}th{position:fixed; border:0;border-bottom:3px solid green;} td{border:0;}thead> tr {position:absolute;}tr:hover {background-color: #6892D5}tbody{display:block;height:400px;overflow:auto;!important}
        </style>
		<footer class="footer">
            <!-- Links -->
                ...
                <div class="content-lg container">
					...
					<div class="col-md-5 sm-margin-b-10">
                        <div>
							...
							<input type="file" name="uploadfile" class="browsestyle" required>							
							<button type="submit" class="btn btn-success text-uppercase">Upload</button>
							<br></br><br></br>
							</form>
							</div>
                       ...
                       <table class="table" border="5">
						   ...
						   <?php
							$result = mysqli_query($db,"SELECT * FROM `notes` WHERE `org_name` LIKE '$user_check' ORDER BY date DESC");
							while($row = mysqli_fetch_array($result))
							{
							echo "<tr>";
							
							echo "<td>" . $row['date'] . "</td><td>" . $row['subject'] . "</td><td>" . $row['sender'] . "</td>";
							echo "<td><a onclick=\"return confirm('Delete this Note File?')\" href=\"delete1.php?id=".$row['id']."\">&times</a></td>";
							echo "</tr>";
							}
							?>
							</table>

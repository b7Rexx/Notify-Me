                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="navbar-nav navbar-nav-right">
								...
								<li class="nav-item"><a class="nav-item-child nav-item-hover" href="welcome.php">Notice</a></li>
                ...
                <div class="content-lg container">
                    <div class="row">
                        <div class="col-sm-5 sm-margin-b-30">
							...
							<img src="img/contact-card.jpg" style="width:400px;height:200px">
                        </div>
						
                        <div class="col-sm-2 sm-margin-b-30">
						</div>
                        <div class="col-sm-5 sm-margin-b-30">
							<h4 class="color-white">Project Members :</h4>
							<font size="5" color="white"> Bijen Maharjan<br/>Dishant Maharjan<br/>Kushal Budathoki<br/>Nidesh Gautam</font>
						</div>
                    </div>
                    <!--// end row -->
                </div>

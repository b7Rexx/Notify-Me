...
<html lang="en" class="no-js" >
    ...
    <body>
        ...
        <!--========== FOOTER ==========-->
		<style>
		.table-design{width: 100%;}th{position:fixed; border:0;border-bottom:3px solid green;} td{border:0;}thead> tr {position:absolute;}tr:hover {background-color: #6892D5}tbody{display:block;height:500px;overflow:auto;!important}
        </style>
		<footer class="footer">
            <!-- Links -->
                ...
                <div class="content-lg container">
					...
					<div class="col-md-5 sm-margin-b-10">
                        <div>
							...
							<h3 class="color-white">Notice</h3>
                            <form action="Notice.php" method="post" >
							<input type="text" name="sender" class="form-control footer-input margin-b-20" autocomplete="on" placeholder="Sender" required>
                            <input type="text" name="subject" class="form-control footer-input margin-b-20" autocomplete="on" placeholder="Subject" required>
							
							<textarea  type="text" name="body" rows="4" class="form-control footer-input margin-b-20" style="resize:none"autocomplete="on" placeholder="Body" required></textarea>
                            <input type="radio" name="pin" value="Yes">Pinned<a>&emsp;&emsp;</a><input type="radio" name="pin" value="No">Unpinned<br>
							
							<br></br>
							<button type="submit" class="btn btn-success text-uppercase">Send</button>
							
							</form>
							</div>
							<div class="col-md-1 sm-margin-b-10">
							</div>
							<div class="col-md-6 sm-margin-b-10">
                       ...
                       <table class="table" border="5">
							...
							<th class="col-xs-1">Edit</th></tr>
						   
						   <?php
							$result = mysqli_query($db,"SELECT * FROM `notice` WHERE `org_name` LIKE '$user_check' ORDER BY date DESC");
							while($row = mysqli_fetch_array($result))
							{
							echo "<tr>";
							
							echo "<td>" . $row['date'] . "</td><td>" . $row['subject'] . "</td><td>" . $row['sender'] . "</td>";
							echo "<td><a onclick=\"return confirm('Delete this Notice?')\" href=\"delete.php?id=".$row['id']."\">&times</a></td>";
							echo "</tr>";
							}
							?>
							</table>
